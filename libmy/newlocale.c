...
{
  UEFI_dprintf( D_INFO , "--> __newlocale()\n" ) ;
  ...
  UEFI_dprintf( D_INFO , "category_mask=%d\nlocale=%s\nbase=0x%lx\n" , category_mask , locale , (unsigned long) base ) ;
  UEFI_dprintf( D_INFO , "<-- __newlocale() : %lx\n" , (unsigned long) _nl_C_locobj_ptr ) ;
...
__typeof (__newlocale) newlocale __attribute__((weak, alias("__newlocale"))) ;
